                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="asal_sekolah" class="form-control" value="<?= $mahasiswa['asal_sekolah']; ?>" id="asal_sekolah" placeholder="Asal Sekolah">
                        ...
                        <button type="submit" name="update" class="btn btn-primary float-right">ubah Mahasiswa</button>
                    </form>
                </div>
            </div>
        </div>
